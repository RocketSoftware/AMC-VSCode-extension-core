...
2. Download the required extension file (```.vsix```) from GitHub.
Downloading from the Visual Studio Marketplace is no longer supported.
* [**Rocket Analyzer extension**](https://github.com/RocketSoftware/AMC-VSCode-extension-analyzer/releases)
* [**Rocket Enterprise extension**](https://github.com/RocketSoftware/AMC-VSCode-extension-enterprise/releases)
* [**Rocket COBOL extension**](https://github.com/RocketSoftware/AMC-VSCode-extension-core/releases)
* [**Rocket Learn COBOL extension**](https://github.com/RocketSoftware/AMC-VSCode-extension-learncobol/releases)
* [**Rocket JVM COBOL**](https://github.com/RocketSoftware/AMC-VSCode-extension-jvmcobol/releases)

  **Note:** We recommend that you always download and install the latest version of the extensions.

3. Select the release from this GitHub repository and download the signature (```.asc```) file for the selected release. 
